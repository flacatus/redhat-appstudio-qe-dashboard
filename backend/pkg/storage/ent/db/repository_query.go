...
func (rgb *RepositoryGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RepositoryGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RepositoryGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositoryGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RepositoryGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RepositoryGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RepositoryGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositoryGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RepositoryGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RepositoryGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RepositoryGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositoryGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RepositoryGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RepositoryGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RepositoryGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositoryGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RepositorySelect) Strings(ctx context.Context) ([]string, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RepositorySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RepositorySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositorySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RepositorySelect) Ints(ctx context.Context) ([]int, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RepositorySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RepositorySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositorySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RepositorySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RepositorySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RepositorySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositorySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RepositorySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RepositorySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RepositorySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{repository.Label}
	default:
		err = fmt.Errorf("db: RepositorySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
